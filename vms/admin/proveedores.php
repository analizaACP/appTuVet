...
if(isset($_POST['submit']))
{
    ...
    $query=("INSERT INTO proveedores(prov_nombre,prov_nit,prov_nrc,prov_nombrecheque,prov_ldireccion1,prov_ldireccion2,prov_telefono,prov_nombrecontacto,creadapor,fecha_creacion,activosn,prov_correo,sucursal_crea)
      VALUES ('$_REQUEST[vendorname]','$_REQUEST[vendornit]','$_REQUEST[vendornrc]','$_REQUEST[vendoremitir]','$_REQUEST[vendordireccion1]','$_REQUEST[vendordireccion2]','$_REQUEST[vendortelefono]','$_REQUEST[vendorcontacto]','$_SESSION[login]',to_date('$fecha_actual','dd/mm/yy'),1,'$_REQUEST[vendorcorreo]','$_SESSION[sucursal]')");
