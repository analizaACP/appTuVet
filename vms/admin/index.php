...
if(isset($_POST['enviar']))
{
    ...
    $result = pg_query($db, "select * from administradores where admin_iniciales='$_REQUEST[username]' and admin_passwd='$_REQUEST[password]'");
    if (!$result) {
        echo "Ocurrió un error.\n";
        exit;
    }
    $result2 = pg_query($db, "select * from administradores where admin_nombre='$_REQUEST[username]' and admin_passwd='$_REQUEST[password]'");
    if (!$result2) {
        echo "Ocurrió un error.\n";
        exit;
    }
