...
if(isset($_POST['enviar']))
{
    ...
    $result = pg_query($db, "select * from gerentes where gerente_iniciales='$_REQUEST[username]' and gerente_passwd='$_REQUEST[password]'");
    if (!$result) {
        echo "Ocurrió un error.\n";
        exit;
    }
    $result2 = pg_query($db, "select * from gerentes where gerente_nombre='$_REQUEST[username]' and gerente_passwd='$_REQUEST[password]'");
    if (!$result2) {
        echo "Ocurrió un error.\n";
        exit;
    }
